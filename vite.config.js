  ...
  plugins: [
    {
      ...
      closeBundle() {
        ...
        if (fs.existsSync(cssPath)) {
          ...
          const markdownCssContent = markdownComment + cssContent + '\n:root { --p-margin: 32px 0 0 0 !important; }\n'
          fs.writeFileSync(path.resolve(__dirname, 'dist/style-markdown.css'), markdownCssContent)
